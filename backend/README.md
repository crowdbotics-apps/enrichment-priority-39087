...
## Project Structure
    ...
    ├── enrichment_priority_39087  # Django project configurations
...
1. Clone this repo and `cd enrichment_priority_39087`
...
2. Clone this repo and `cd enrichment_priority_39087`
